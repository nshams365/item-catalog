...
item1 = Item(user_id=1, name="Programming with C",
...
item2 = Item(user_id = 1, name = "The Da Vinci Code",
                     description ="fiction",
                     author="Dan Brown",
...
item3 = Item(user_id=1, name="Digital Fortress",
             description="fiction",
             author="Dan Brown",
...
item4 = Item(user_id=1, name="Ching's Fast Food",
...
item5 = Item(user_id=1, name="The Dukan Diet",
...
item6 = Item(user_id=1, name="Wavesphere Application Server v8.5",
